...
public class UserDrawMapReduce {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.addInputPath(job1, new Path("file:///F:/userdraw/data"));// 输入路径
		FileOutputFormat.setOutputPath(job1, new Path("file:///F:/userdraw/data/out"));// 输出路径
		...
		System.out.println("job1执行成功！！！");
			if (state1) {
				...
				FileInputFormat.addInputPath(job2, new Path("file:///F:/userdraw/data/out")); // 输入路径
				FileOutputFormat.setOutputPath(job2, new Path("file:///F:/userdraw/data/out2"));// 输出路径
